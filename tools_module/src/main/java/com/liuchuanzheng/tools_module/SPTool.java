...
public class SPTool {
     ...
     * 默认使用包名作为name
     */
    private static String NAME = ApplicationUtil.getCurApplication().getPackageName();
    ...
    private static void setParam(String name, String key, Object object) {
        SharedPreferences sp = ApplicationUtil.getCurApplication().getSharedPreferences(name, Context.MODE_PRIVATE);
